...
const Moretourprops = ({more}) => {
    return ( 
      ...
      />
      <div className="p-4">
      <p className="text-[#2D2D2D] text-[20px] font-inter font-bold">{more.name}</p>
         ...
         We'll dive into the rich history, flavorful cuisine,
          city and village life and vibrant cultures in a style
           ...
           <div className="flex pt-[10px] gap-4">
            <SlCalender className="text-[24px] text-[#885252]"/>
